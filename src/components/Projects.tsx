  ...
  return (
    <div>
      ...
      >
        ...
        <div className="scroll z-20 flex w-full snap-x overflow-y-hidden  overflow-x-scroll scroll-smooth  scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#4682B4]">
