...
// scroll doesn't happen once we get past small size 
      ...
      >
        ...
        <div className="relative z-20 flex w-full snap-x snap-mandatory overflow-y-hidden overflow-x-scroll">
          {projects.map((project, index) => (
            <div className="flex h-screen w-screen flex-shrink-0 snap-center flex-col items-center justify-center space-y-5 p-20 md:p-44" key={index}>
              <motion.div initial={{y:-300, opacity: 0}} transition={{ duration: 1 }}
